...
export const COCKTAILS: CocktailRecipe[] = [
  {
    ...
    prepTime: "5 min",
    difficulty: "Moyen",
    description: "Le mythique cocktail cubain, frais, acidulé et parfaitement équilibré. Idéal en toute saison."
  },
  {
    id: "cuba-libre",
    name: "Cuba Libre",
    ...
    prepTime: "2 min",
    difficulty: "Facile",
    description: "Un classique indémodable né à La Havane, mêlant la fraîcheur du citron vert au caractère du rhum."
  },
  {
    id: "daiquiri",
    name: "Daiquiri",
    ...
    prepTime: "3 min",
    difficulty: "Moyen",
    description: "La pureté des saveurs : acidité franche du citron vert, douceur du sucre et arômes du rhum blanc."
  },
  {
    id: "pina-colada",
    name: "Piña Colada",
    ...
    prepTime: "4 min",
    difficulty: "Moyen",
    description: "Cocktail onctueux et tropical par excellence. Le mariage parfait de la noix de coco et de l'ananas."
  },
  {
    id: "old-fashioned",
    name: "Old Fashioned",
    ...
    prepTime: "4 min",
    difficulty: "Expert",
    description: "Le roi des cocktails classiques. Un régal boisé et aromatique à déguster lentement au coin du feu."
  },
  {
    id: "whisky-coca",
    name: "Whisky-Coca",
    ...
    prepTime: "1 min",
    difficulty: "Facile",
    description: "La simplicité même. Idéal pour les fins de soirée sans fioritures."
  },
  {
    id: "godfather",
    name: "Godfather",
    ...
    prepTime: "2 min",
    difficulty: "Facile",
    description: "Un cocktail aromatique et doux, où les notes d'amandes de l'Amaretto arrondissent le caractère du scotch."
  },
  {
    id: "gin-tonic",
    name: "Gin Tonic",
    ...
    prepTime: "2 min",
    difficulty: "Facile",
    description: "L'élégance britannique en un verre. Amer, pétillant, et profondément rafraîchissant."
  },
  {
    id: "negroni",
    name: "Negroni",
    ...
    prepTime: "3 min",
    difficulty: "Expert",
    description: "L'apéritif italien par excellence : un équilibre fascinant entre amertume, douceur et puissance botanique."
  },
  {
    id: "martini",
    name: "Dry Martini",
    ...
    prepTime: "3 min",
    difficulty: "Expert",
    description: "Le cocktail mythique des agents secrets et des esthètes. Sec, glacé, et terriblement sophistiqué."
  },
  {
    id: "moscow-mule",
    name: "Moscow Mule",
    ...
    prepTime: "3 min",
    difficulty: "Facile",
    description: "Un cocktail frais, épicé et désaltérant grâce à la puissance du gingembre et du citron vert."
  },
  {
    id: "cosmopolitan",
    name: "Cosmopolitan",
    ...
    prepTime: "3 min",
    difficulty: "Moyen",
    description: "Acidulé, fruité et élégant, ce cocktail rose vif est une icône de la culture pop urbaine."
  },
  {
    id: "margarita",
    name: "Margarita",
    ...
    prepTime: "3 min",
    difficulty: "Moyen",
    description: "Le grand classique mexicain. Un équilibre parfait entre l'agave sauvage, l'acidité et le sel."
  },
  {
    id: "tequila-sunrise",
    ...
    prepTime: "3 min",
    difficulty: "Facile",
    description: "Un cocktail fruité et coloré, célèbre pour son magnifique dégradé évoquant l'aurore."
  },
  {
    id: "spritz",
    name: "Aperol Spritz",
    ...
    prepTime: "2 min",
    difficulty: "Facile",
    description: "Pétillant, légèrement amer et ensoleillé, le spritz évoque instantanément les terrasses de Venise."
  },
  {
    id: "kir-royal",
    name: "Kir Royal",
    ...
    prepTime: "2 min",
    difficulty: "Facile",
    description: "Le raffinement français. Idéal pour fêter un grand événement ou accueillir ses convives."
  },
  {
    id: "amaretto-sour",
    name: "Amaretto Sour",
    ...
    prepTime: "4 min",
    difficulty: "Moyen",
    description: "Une merveille douce-amère à la texture veloutée incomparable."
  }
];
