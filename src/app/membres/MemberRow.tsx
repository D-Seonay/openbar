    ...
    <div className="p-4 sm:p-4.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 hover:bg-ink-2 transition-colors">
      ...
      <div className="flex flex-wrap items-center gap-2 text-xs">
        <button
          ...
          className="tap-target-sm flex items-center px-3 py-1.5 rounded-xl bg-ink border border-white/[0.08] text-cream transition-colors cursor-pointer hover:bg-ink-2 hover:border-white/[0.12]"
        >
        ...
        <button
          ...
          className={`tap-target-sm flex items-center px-3 py-1.5 rounded-xl border transition-colors cursor-pointer font-semibold ${
            member.vip
        ...
        <button
          ...
          className="tap-target-sm flex items-center px-3 py-1.5 rounded-xl bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 text-red-400 transition-colors cursor-pointer"
        >
          Révoquer
        </button>
      </div>
