  ...
  return (
    <html lang="fr" className={`h-full ${outfit.variable} ${jakarta.variable}`}>
      <body className="min-h-full flex flex-col bg-ink text-cream selection:bg-orange/30 selection:text-white font-sans antialiased relative overflow-x-hidden">
        {/* Subtle Warm Lounge Ambient Lighting */}
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
          <div className="absolute -top-32 -left-32 w-[500px] h-[500px] rounded-full bg-orange/[0.045] blur-[140px]" />
          <div className="absolute top-1/3 -right-32 w-[450px] h-[450px] rounded-full bg-gold/[0.04] blur-[150px]" />
        </div>
